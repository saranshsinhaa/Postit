            ...
            <div className="grid gap-x-6 md:grid-cols-3 lg:gap-x-12">
              <div className="mb-6 lg:mb-0">
                <div className="block rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
                  ...
                  <div className="p-6">
                    <h5 className="mb-4 text-lg font-bold text-neutral-300">
                      Maria Smith
                    </h5>
                    <p className="mb-4 text-neutral-300">Frontend Developer</p>
                    <ul className="mx-auto flex list-inside justify-center">
                      <a href="#!" className="px-2">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          viewBox="0 0 24 24"
                          className="text-primary dark:text-primary-400 h-4 w-4"
                        >
                          <path
                            fill="currentColor"
                      ...
                      <a href="#!" className="px-2">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          viewBox="0 0 24 24"
                          className="text-primary dark:text-primary-400 h-3.5 w-3.5"
                        >
                          <path
                            fill="currentColor"
              ...
              <div className="mb-6 lg:mb-0">
                <div className="block rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
                  ...
                  <div className="p-6">
                    ...
                    <p className="mb-4 text-neutral-300">Marketing expert</p>
                    <ul className="mx-auto flex list-inside justify-center">
                      <a href="#!" className="px-2">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
              ...
              <div className="">
                <div className="block rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
                  ...
                  <div className="p-6">
                    ...
                    <p className="mb-4 text-neutral-300">Web designer</p>
                    <ul className="mx-auto flex list-inside justify-center">
                      <a href="#!" className="px-2">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
